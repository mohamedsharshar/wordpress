...
final class License {
	...
	const LICENSE_DATA_OPTIONS_KEY = Main::PRODUCT_KEY . '_license_data';
	const LICENSE_KEY_OPTION_KEY   = Main::PRODUCT_KEY . '_license';
	const LICENSE_TRANSIENT_KEY    = Main::PRODUCT_KEY . '_license_check';
	 ...
	 * Get the URL.
	 *
	 * For VIP, use vip_safe_wp_remote_get.
	 *
