	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'show_label'  => true,
				'default'     => sprintf(
					'<p style="text-align: center;"><strong>%s</strong></p><h6 style="text-align: center; font-weight: 600;">%s</h6><p style="text-align: center;">%s</p>',
					esc_html( 'Dribbble' ),
					// translators: dummy text for placeholder.
					esc_html__( 'Dribbble just acquired Crew, a very interesting startup...', 'neve-pro-addon' ),
					// translators: dummy text for placeholder.
					esc_html__( 'Don\'t be scared of the truth because we need to restart the human foundation in truth And I love you like Kanye loves Kanye I love Rick Owens\' bed design but the back is...', 'neve-pro-addon' )
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'show_label'  => true,
				'default'     => sprintf(
					'<p style="text-align: center;"><strong>%s</strong></p><h6 style="text-align: center; font-weight: 600;">%s</h6>',
					esc_html( 'Dribbble' ),
					// translators: dummy text for placeholder.
					esc_html__( 'Dribbble just acquired Crew, a very interesting startup...', 'neve-pro-addon' )
				),
