...
class Module extends Abstract_Module {
	...
	public function add_post_infinite_scroll() {
		...
		$from_same_cat = get_theme_mod( 'neve_post_nav_infinite_same_category', true );
		...
		$previous = function_exists( 'wpcom_vip_get_adjacent_post' ) ?
			wpcom_vip_get_adjacent_post( $from_same_cat, array(), true ) :
			get_adjacent_post( $from_same_cat, '', true ); //phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.get_adjacent_post_get_adjacent_post
