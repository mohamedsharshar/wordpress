...
const Component = ( { metaFields, setMetaFields } ) => {
	...
	return (
		<PluginDocumentSettingPanel
			...
			title={ __( 'Content Restriction', 'neve-pro-addon' ) }
		>
			<Toggle
				...
				label={ __( 'Restrict Except User Roles', 'neve-pro-addon' ) }
			/>
			...
			<Toggle
				...
				label={ __( 'Restrict Except Password', 'neve-pro-addon' ) }
			/>
