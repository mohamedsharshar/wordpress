...
const TermSettings = () => {
	...
	return (
		<>
			<h2>{ __( 'Content restriction', 'neve-pro-addon' ) }</h2>
			<input
				type="hidden"
			...
			<Toggle
				...
				label={ __( 'Allowed User Roles', 'neve-pro-addon' ) }
			/>
			...
			<Toggle
				...
				label={ __( 'Allowed Users', 'neve-pro-addon' ) }
			/>
			...
			<Toggle
				...
				label={ __( 'Password', 'neve-pro-addon' ) }
				disabledText={ __(
