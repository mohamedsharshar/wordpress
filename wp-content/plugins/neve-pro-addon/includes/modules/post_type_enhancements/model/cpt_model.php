...
class CPT_Model {
	...
	final public function get_taxonomies() {
		...
		return $this->cpt_object->taxonomies;
	}

	/**
	 * Check current page is archive or taxonomy page or not.
	 *
	 * @return bool
	 */
	final public function is_archive_or_taxonomy_page() {
		return is_post_type_archive( $this->get_type() ) || is_tax( $this->get_taxonomies() );
	}
}
