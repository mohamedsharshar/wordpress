...
use Neve_Pro\Modules\Header_Footer_Grid\Extensions\Logo;
...
class Module extends Abstract_Module {
	...
	public function setup_labels() {
		...
		$this->description   = __( 'Create unique sticky & transparent headers that adapt to scroll. Perfect for modern, immersive websites.', 'neve-pro-addon' );
	...
	public function run_module() {
		...
		if ( Loader::has_compatibility( 'component_style_filter' ) ) {
			( new Logo() )->init();
		}
