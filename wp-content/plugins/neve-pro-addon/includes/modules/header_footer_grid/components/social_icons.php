...
class Social_Icons extends Abstract_Component {
					...
					'fields' => array(
						...
						'source_selector'  => array(
							...
							'options' => array(
								...
								'image' => array(
									'label'  => __( 'Custom', 'neve-pro-addon' ),
									'fields' => array(
										'img_src',
									),
								),
						...
						'icon_color'       => array(
							'type'   => 'color',
							'label'  => __( 'Icon Color', 'neve-pro-addon' ),
							'parent' => 'source_selector',
						),
	...
	public function sanitize_social_icons_repeater( $value ) {
		...
		foreach ( $decoded as $item ) {
			...
			if ( isset( $item['source_selector'] ) && 'image' === $item['source_selector'] && ! empty( $item['img_src'] ) ) {
				if ( ! wp_http_validate_url( $item['img_src'] ) ) {
					continue;
				}
			} elseif ( ! array_key_exists( 'icon', $item ) || ! array_key_exists( 'visibility', $item ) ) {
				continue;
			}
