...
class Infinite_Scroll {
	...
	/**
	 * Get result count markup from `loop/result-count.php` for infinite scroll conditions.
	 *
	 * @return string
	 * 
	 * @see https://github.com/woocommerce/woocommerce/blob/3b1bb3813170b7dc8083dd98f8648d0515749a16/plugins/woocommerce/includes/wc-template-functions.php#L1507
	 * @see https://github.com/woocommerce/woocommerce/blob/3b1bb3813170b7dc8083dd98f8648d0515749a16/plugins/woocommerce/templates/loop/result-count.php
	 */
	private function result_count() {
		$args = array(
			'total'    => wc_get_loop_prop( 'total' ),
			'per_page' => wc_get_loop_prop( 'per_page' ) * wc_get_loop_prop( 'current_page' ),
			'current'  => 1,
		);
