	...
	private function add_edd_sections() {
		...
		$this->add_section(
			new Section(
				...
				array(
					'priority' => 60,
					'title'    => esc_html__( 'Easy Digital Downloads', 'neve-pro-addon' ),
	...
	private function add_archive_title_controls() {
		...
		$this->add_control(
			new Control(
				...
				array(
					'label'            => esc_html__( 'Download Title', 'neve-pro-addon' ),
					'category_label'   => __( 'Download Archive', 'neve-pro-addon' ),
	...
	private function add_archive_meta_controls() {
		...
		$this->add_control(
			new Control(
				...
				array(
					'label'            => esc_html__( 'Download Meta', 'neve-pro-addon' ),
					'section'          => 'neve_edd_typography',
					'priority'         => 10,
	...
	private function add_single_title_controls() {
		...
		$this->add_control(
			new Control(
				...
				array(
					'label'            => esc_html__( 'Download Title', 'neve-pro-addon' ),
					'category_label'   => __( 'Single Download', 'neve-pro-addon' ),
					'section'          => 'neve_edd_typography',
					'priority'         => 15,
