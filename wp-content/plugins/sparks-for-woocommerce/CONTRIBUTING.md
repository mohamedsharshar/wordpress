...
Once the release is done, we need to [update it on WooCommerce.com](https://woocommerce.com/document/marketplace-manage-products/).

You will find the .zip file in the artifacts of Woo Build Action that will be triggered on the release.
